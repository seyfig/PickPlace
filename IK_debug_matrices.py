...
def test_code(test_case):
    ...
    R36 = simplify(T3_4[0:3,0:3] * T4_5[0:3,0:3] * T5_6[0:3,0:3])
    print("R36:\n")
    pprint(R36)
    ...
    T0_EE = Rot_EE.row_join(EE)

    print("T0_EE:\n")
    pprint(T0_EE)

    T0_EE = T0_EE.col_join(Matrix([[0, 0, 0, 1]]))
    print("T0_EE2:\n")
    pprint(T0_EE)
    ...
    T0_EE = T0_EE.evalf(subs={'px':eex, 'py':eey, 'pz':eez, 'r': roll, 'p': pitch, 'y':yaw})
    print("T0_EE3:\n")
    pprint(T0_EE)
